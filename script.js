...
//Selecionar os parágrafos com a classe 'mensagem2'

const mensagens = document.getElementsByClassName("mensagem2");

//Criar o botão que vai modificar as frases

const botaoFrases = document.createElement('button');
botaoFrases.textContent = 'Modificar frases';
document.querySelector('.container').appendChild(botaoFrases);
